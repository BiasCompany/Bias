...
final class ChooseUndertoneViewModel: ObservableObject {
    ...
    private let resultDescription: [String: String] = [
        ...
        "Netral": "With Netral undertones, warm and cool tones balance, revealing your skin’s natural shade."
    ]
    ...
    let questions: [QuizQuestion] = [
        QuizQuestion(
            id: 1,
            title: "WHAT COLOR\nARE YOUR VEINS?",
            tip: "Look at the veins at your wrist, determine it’s color. Preferably do it under natural light to have precise result",
            options: ["Purple", "Blue", "Green", "Bluish-green", "I don’t know"]
        ),
        QuizQuestion(
            id: 2,
            title: "NEXT TO A WHITE CLOTH,\nHOW DOES YOUR SKIN LOOK?",
            tip: "Put a plain white cloth next to your bare face in natural light, what is the result?",
            options: ["My skin looks yellowish", "My skin looks pinkish or bluish", "My skin looks neither too yellow or pink"]
        ),
        QuizQuestion(
            id: 3,
        ...
        QuizQuestion(
            ...
            tip: "When comparing pure white and cream-colored clothes against your skin (with no makeup), which one makes you look better?",
