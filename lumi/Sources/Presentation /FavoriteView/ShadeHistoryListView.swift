...
struct ShadeHistoryListView: View {
    ...
    private var items: [(title: String, date: String, color: Color, products: [HistoryProduct])] {
        let p1 = HistoryProduct(
            brand: "WARDAH", productLine: "ALL HOURS FOUNDATION", shadeCode: "120C", match: 0.96,
            imageURL: demoURL, shadeColor: Color(red: 210 / 255, green: 180 / 255, blue: 140 / 255))
        let p2 = HistoryProduct(
            brand: "MAYBELLINE", productLine: "FIT ME FOUNDATION", shadeCode: "220", match: 0.91,
            imageURL: demoURL, shadeColor: Color(red: 218 / 255, green: 190 / 255, blue: 150 / 255))
        return [
            (
                "MEDIUM SKIN TONE", "12 August 2025",
                Color(red: 223 / 255, green: 177 / 255, blue: 145 / 255), [p1, p2]
            ),
            (
                "MEDIUM SKIN TONE", "11 August 2025",
                Color(red: 223 / 255, green: 177 / 255, blue: 145 / 255), [p1]
            ),
            (
                "MEDIUM SKIN TONE", "10 August 2025",
                Color(red: 223 / 255, green: 177 / 255, blue: 145 / 255), [p2, p1]
            ),
            (
                "MEDIUM SKIN TONE", "9 August 2025",
                Color(red: 223 / 255, green: 177 / 255, blue: 145 / 255), [p2]
            ),
        ]
    }
