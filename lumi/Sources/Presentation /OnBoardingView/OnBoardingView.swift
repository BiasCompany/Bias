...
struct OnBoardingView: View {
    ...
    let titles = [
        "DISCOVER YOUR SKIN'S TRUE SHADE",
        "FIND THE SHADE MATCH FOR YOU",
        "READY TO MAKE A MATCH?"
    ]
    let subTitles = [
        "Let the camera unveil your skin tone.",
        "Experience the ease of finding a foundation crafted just for your skin.",
        "We'll help you to uncover your true beauty."
    ]
    ...
    var body: some View {
        VStack {
            ...
            VStack{
                ...
                // Subtitle (changes with currentPage)
