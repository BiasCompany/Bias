...
final class ResultAnalyzeViewmodel: ObservableObject {
    ...
    @Published var detectionPoints: [DetectionPoint] = [
        DetectionPoint(
            id: 1, position: CGPoint(x: 0.3, y: 0.2),
            color: .init(red: 0.85, green: 0.75, blue: 0.65)),
        DetectionPoint(
            id: 2, position: CGPoint(x: 0.2, y: 0.5), color: .init(red: 0.8, green: 0.7, blue: 0.6)),
        DetectionPoint(
            id: 3, position: CGPoint(x: 0.8, y: 0.5),
            color: .init(red: 0.75, green: 0.65, blue: 0.55)),
        DetectionPoint(
            id: 4, position: CGPoint(x: 0.5, y: 0.7), color: .init(red: 0.7, green: 0.6, blue: 0.5)),
        DetectionPoint(
            id: 5, position: CGPoint(x: 0.5, y: 0.6), color: .init(red: 0.8, green: 0.7, blue: 0.6)),
    ]
